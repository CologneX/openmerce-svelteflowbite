<script lang="ts">
    ...
    import {Badge, Button, Heading, Input, P} from "flowbite-svelte";
...
<div class="space-y-8">
    <div class="space-y-2">
        <Heading tag="h4">Transaction List</Heading>
    ...
    <div class="flex flex-col space-y-4">
        {#each products as mantap}
            <div class="shadow-md rounded-md p-4 dark:bg-gray-700">
                ...
                <div class="flex flex-row gap-x-4">
                    ...
                    <div class="truncate grid grid-flow-col w-full">
                        ...
                        <div class="justify-self-end sm:pr-10 pl-2 hidden sm:block">
                            <span class=" text-xs md:text-sm text-neutral-400">Total Price</span>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-1 ">
                    <div class="sm:pr-10 pl-2 sm:hidden">
                        <span class="text-xs text-neutral-400">Total Price</span>
                        <P class="font-bold text-sm md:text-base">Rp. 0</P>
                    </div>
